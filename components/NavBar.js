const navbar = Vue.createApp({
            ...
            <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
                <ul class="navbar-nav navbar-animated mb-2 mb-lg-0 nav-links">
                    <li class="nav-item" style="height: 46px;">
                        <img class="nav-icon" src="./fb-logo2-white.svg" alt="" width="32" height="32">
                    </li>
                    <div class="nav-links-container">
                        <li v-for="link in links" :key="link.lbl"
                            class="nav-item">
                            <a type="button" class="nav-link" data-bs-target="#carouselExample" :data-bs-slide-to="link.target" :aria-label="link.lbl">
    ...
    methods: {
        carousel(txt, icon) {
            ...
            return { carousel: true, id: '#carouselExample', target, txt, lbl:`Slide ${target}`, icon: `bi-${icon}` }
        }
    },
    computed: {
        links() {
